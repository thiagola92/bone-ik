...
func _update_shapes() -> void:
	...
	_bone_shape.visible = not autocalculate_length_and_angle and _bone_shapes.size() == 0
	_bone_outline_shape.visible = not autocalculate_length_and_angle and _bone_shapes.size() == 0
